...
def welcome():
 ...
 if not session.get('logged_in'):
    ...
    return render_template('welcome.html',title='TellMe',page_title='TellMe',username=session.get('username'),init_prev_chats=prev_read_chats)
...
def login():
    ...
    if request.method == 'POST':
        ...
        if request.form['inputUsername'] == 'tjs':
            ...
            return render_template('login.html',title='Login to TellMe',page_title='TellMe',error=error)
    ...
    return render_template('login.html',
                         title='Login to TellMe',
                                                 page_title='TellMe',error=error)
